...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/mac/Desktop/Lab in Psych/V4/v4_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text='Press the following keys for the following positions:\n\nNumbers go from left to right\n\nZ - 1st line\nX - 2nd line\nC - 3rd line\nV - 4th line\n\nPress SPACE to start',
        font='Arial',
    ...
    trials = data.TrialHandler(nReps=50.0, method='sequential', 
        ...
        trialList=data.importConditions('seq_cond.xlsx'),
