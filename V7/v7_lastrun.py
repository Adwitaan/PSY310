...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/mac/Desktop/Lab in Psych/V7/v7_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text_3 = visual.TextStim(win=win, name='text_3',
        text="2 values will be given to the participant with a choice, the participant has to press the key 't' for the value being offered 'today' or 'l' if the value they select is being offered at a later date. \n\nPress SPACE to start",
        font='Arial',
    ...
    InsComponents = [text_3, key_resp_2]
