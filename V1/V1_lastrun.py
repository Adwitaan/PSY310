...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/mac/Desktop/Lab in Psych/V1/V1_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text='Press left for left and right for right and press space to start',
        font='Arial',
    ...
    grating = visual.GratingStim(
        ...
        ori=1.0, pos=(0, 0), size=(0.5, 0.5), sf=8.0, phase=0.0,
        color=[1,1,1], colorSpace='rgb',
        opacity=None, contrast=0.3, blendmode='avg',
        texRes=128.0, interpolate=True, depth=-2.0)
    key_resp = keyboard.Keyboard(deviceName='key_resp')
    
    # --- Initialize components for Routine "Thnx" ---
    ...
    # --- Prepare to start Routine "Thnx" ---
    continueRoutine = True
    # update component parameters for each repeat
    thisExp.addData('Thnx.started', globalClock.getTime(format='float'))
    textbox.reset()
    # keep track of which components have finished
    ThnxComponents = [textbox]
    for thisComponent in ThnxComponents:
        thisComponent.tStart = None
        thisComponent.tStop = None
        thisComponent.tStartRefresh = None
        thisComponent.tStopRefresh = None
    ...
    for thisComponent in ThnxComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    thisExp.addData('Thnx.stopped', globalClock.getTime(format='float'))
