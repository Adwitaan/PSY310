...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/mac/Desktop/0_Solo/Solo_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler(nReps=1.0, method='random', 
        ...
        trialList=data.importConditions('origialconditions.xlsx'),
    ...
    for thisTrial in trials:
        ...
        originalComponents = [fixation, image]
        ...
        while continueRoutine:
            ...
            if fixation.status == STARTED:
                ...
                if tThisFlipGlobal > fixation.tStartRefresh + 7.0-frameTolerance:
            ...
            if image.status == NOT_STARTED and tThisFlip >= 7.0-frameTolerance:
                # keep track of start time/frame for later
    ...
    trials_2 = data.TrialHandler(nReps=1.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('mixedconditions.xlsx'),
    ...
    for thisTrial_2 in trials_2:
        ...
        _key_resp_allKeys = []
        # keep track of which components have finished
        mixedComponents = [fixation1, image_2, key_resp]
